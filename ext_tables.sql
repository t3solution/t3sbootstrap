...
CREATE TABLE tx_t3sbootstrap_domain_model_config (
	...
	page_title varchar(10) DEFAULT 'jumbotron' NOT NULL,
	page_titlealign varchar(7) DEFAULT 'center' NOT NULL,
	...
	navbar_enable varchar(7) DEFAULT 'light' NOT NULL,
	navbar_entrylevel int(2) DEFAULT '0' NOT NULL,
	navbar_levels int(2) DEFAULT '4' NOT NULL,
	...
	navbar_brand varchar(7) DEFAULT 'imgText' NOT NULL,
	navbarbrand_alignment varchar(5) DEFAULT 'left' NOT NULL,
	navbar_image varchar(255) DEFAULT '' NOT NULL,
	navbar_color varchar(40) DEFAULT 'primary' NOT NULL,
	navbar_background varchar(255) DEFAULT '' NOT NULL,
	navbar_transparent tinyint(1) unsigned DEFAULT '0' NOT NULL,
	navbar_container varchar(15) DEFAULT 'container' NOT NULL,
	navbar_innercontainer varchar(15) DEFAULT '' NOT NULL,
	navbar_placement varchar(12) DEFAULT 'fixed-top' NOT NULL,
	...
	navbar_lang_flags tinyint(1) unsigned DEFAULT '1' NOT NULL,
	jumbotron_enable tinyint(1) unsigned DEFAULT '1' NOT NULL,
	jumbotron_bgimage varchar(255) DEFAULT '' NOT NULL,
	jumbotron_bgimageratio varchar(255) DEFAULT '37:9' NOT NULL,
	jumbotron_alignitem varchar(255) DEFAULT '' NOT NULL,
	jumbotron_slide tinyint(1) unsigned DEFAULT '0' NOT NULL,
	jumbotron_position varchar(8) DEFAULT 'below' NOT NULL,
	...
	breadcrumb_notonrootpage tinyint(1) unsigned DEFAULT '1' NOT NULL,
	...
	breadcrumb_position varchar(8) DEFAULT 'belowJum' NOT NULL,
	breadcrumb_container varchar(15) DEFAULT 'container' NOT NULL,
	...
	sidebar_levels int(2) DEFAULT '4' NOT NULL,
	...
	footer_enable tinyint(1) unsigned DEFAULT '1' NOT NULL,
	footer_slide tinyint(1) unsigned DEFAULT '0' NOT NULL,
	footer_sticky tinyint(1) unsigned DEFAULT '1' NOT NULL,
	footer_container varchar(15) DEFAULT 'container' NOT NULL,
	footer_containerposition varchar(7) DEFAULT 'Inside' NOT NULL,
	footer_class varchar(255) DEFAULT 'bg-dark text-light py-4' NOT NULL,
	...
	disable_prefix_comment tinyint(1) unsigned DEFAULT '1' NOT NULL,
	...
	page_wrapper_extra_class varchar(255) DEFAULT '' NOT NULL,
	...
	global_padding_top varchar(255) DEFAULT 'pt-5' NOT NULL,
	sticky_footer_extra_padding int(11) DEFAULT '100' NOT NULL,
	content_margin_top varchar(255) DEFAULT '' NOT NULL,
	loading_spinner varchar(255) DEFAULT '' NOT NULL,
	loading_spinner_color varchar(255) DEFAULT 'primary' NOT NULL,
	lightbox_selection varchar(255) DEFAULT '1' NOT NULL,
	magnifying tinyint(1) unsigned DEFAULT '0' NOT NULL,
	sectionmenu_anchor_offset int(11) DEFAULT '29' NOT NULL,
	sectionmenu_scrollspy_threshold varchar(255) DEFAULT '0.1, 0.5, 1' NOT NULL,
	sectionmenu_scrollspy_root_margin varchar(255) DEFAULT '0px 0px -75%' NOT NULL,
	sectionmenu_scrollspy tinyint(1) unsigned DEFAULT '1' NOT NULL,
	...
	shrinking_nav_padding varchar(255) DEFAULT '5' NOT NULL,
	sidebar_menu_position varchar(255) DEFAULT 'above' NOT NULL,
	lang_menu_with_fa_icon tinyint(1) unsigned DEFAULT '1' NOT NULL,
	subheader_color varchar(255) DEFAULT 'secondary' NOT NULL,
	date_format varchar(255) DEFAULT 'd.m.Y' NOT NULL,
	...
	record_type varchar(255) DEFAULT 'general' NOT NULL,
	custom_scss text,
	custom_variables_scss text,
...
CREATE TABLE tt_content (
	...
	tx_t3sbootstrap_animateCssDuration varchar(5) DEFAULT '' NOT NULL,
	tx_t3sbootstrap_animateCssDelay varchar(5) DEFAULT '' NOT NULL,
