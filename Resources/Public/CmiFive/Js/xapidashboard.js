  ...
  */
    window.nv.models.tooltip = function () {
      var content = null, //HTML contents of the tooltip.  If null, the content is generated via the data variable.
        data =
          null /* Tooltip data. If data is given in the proper format, a consistent tooltip is generated.
        Format of data:
        {
            key: "Date",
            value: "August 2009", 
      ...
      function getTooltipContainer(newContent) {
        var body;
        if (chartContainer) body = d3.select(chartContainer);
        else body = d3.select("body");
    ...
    return function (series, index) {
      ...
      if (typeof dictionary[key] !== "undefined")
        return typeof dictionary[key] === "function"
          ? dictionary[key]()
          : dictionary[key];
      else return defaultColors[--defIndex]; // no match in dictionary, use default color
    };
  };
      ...
      selection.each(function (data) {
        ...
        switch (axis.orient()) {
          ...
          case "right":
            ...
            axisLabel
              ...
              .attr(
                "x",
                rotateYLabel ? scale.range()[0] / 2 : axis.tickPadding()
              );
            if (showMaxMin) {
              var axisMaxMin = wrap
                .selectAll("g.nv-axisMaxMin")
        ...
        if (
          ...
          wrap.selectAll("g.nv-axisMaxMin").each(function (d, i) {
            try {
              ...
              // i==0, min position
              else maxMinRange.push(scale(d) + this.getBBox().width + 4);
            } catch (err) {
              if (i)
                // i== 1, max position
        ...
        if (highlightZero)
          g.selectAll(".tick")
            .filter(function (d) {
              return (
                !parseFloat(Math.round(d.__data__ * 100000) / 1000000) &&
        ...
        if (markerz[0]) {
          g.selectAll("path.nv-markerTriangle")
            .attr("transform", function (d) {
              return (
                "translate(" + x1(markerz[0]) + "," + availableHeight / 2 + ")"
              );
            })
            .attr(
              "d",
...
*/
        ...
        var barsEnter = bars
          ...
          .on("mouseover", function (d, i) {
            ...
            dispatch.elementMouseover({
              ...
              pos: [
                x(getX(d, i)) +
                  (x.rangeBand() * (d.series + 0.5)) / data.length,
                y(getY(d, i))
            ...
            .style(
              ...
              function (d) {
                return (
                  (index
                    ? 0
                    : d.depth * childIndent + 12 + (icon(d) ? 0 : 16)) + "px"
                );
              },
              "important"
          ...
          nodeName.each(function (d) {
            if (!index && getUrl(d))
              d3.select(this)
                ...
                .append("span");
            else d3.select(this).append("span");
      ...
      selection.each(function (data) {
        ...
        if (align) {
          ...
          height =
            margin.top +
            margin.bottom +
            Math.ceil(seriesWidths.length / seriesPerRow) * 20;
        } else {
          var ypos = 5,
            newxpos = 5,
            maxwidth = 0,
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        var linesWrap = g
          .select(".nv-linesWrap")
          .datum(
            dataLines[0] && !dataLines[0].disabled
              ? dataLines
              : [{ values: [] }]
          );
      ...
      selection.each(function (data) {
          ...
          .on("mouseover", function (d, i) {
            ...
            dispatch.elementMouseover({
              ...
              pos: [
                x(getX(d, i)) +
                  (x.rangeBand() *
                    (stacked ? data.length / 2 : d.series + 0.5)) /
                    data.length,
        ...
        if (stacked)
          bars
            ...
            .attr("height", function (d, i) {
              return Math.max(
                Math.abs(y(d.y + (stacked ? d.y0 : 0)) - y(stacked ? d.y0 : 0)),
                1
              );
            })
            .attr("x", function (d, i) {
  ...
  nv.models.multiChart = function () {
    ...
    var showTooltip = function (e, offsetElement) {
      var left = e.pos[0] + (offsetElement.offsetLeft || 0),
        ...
        y = (e.series.yAxis == 2 ? yAxis2 : yAxis1).tickFormat()(
          lines1.y()(e.point, e.pointIndex)
        ),
        content = tooltip(e.series.key, x, y, e, chart);
  ...
  nv.models.scatter = function () {
        ...
        function updateInteractiveLayer() {
          ...
          if (useVoronoi === true) {
            ...
            pointPaths.attr("d", function (d) {
              if (d.data.length === 0) return "M 0 0";
              else return "M" + d.data.join("L") + "Z";
            });
    ...
    chart.clearHighlights = function () {
      ...
      d3.selectAll(".nv-chart-" + id + " .nv-point.hover").classed(
        "hover",
        false
      );
    };
      ...
      selection.each(function (data) {
        ...
        if (showXAxis) {
          xAxis
            .scale(x)
            .ticks(
              xAxis.ticks() && xAxis.ticks().length
                ? xAxis.ticks()
                : availableWidth / 100
            )
            .tickSize(-availableHeight, 0);
        ...
        if (showYAxis) {
          yAxis
            .scale(y)
            .ticks(
              yAxis.ticks() && yAxis.ticks().length
                ? yAxis.ticks()
                : availableHeight / 36
            )
            .tickSize(-availableWidth, 0);
        ...
        chart.d3_stackedOffset_stackPercent = function (stackData) {
          ...
          for (j = 0; j < m; ++j) {
            ...
            for (
              i = 0, o = 0;
              i < dataRaw.length;
              i++ //looping through series'
            )
              o += getY(dataRaw[i].values[j]); //total value of all points at a certian point in time.

            if (o) for (i = 0; i < n; i++) stackData[i][j][1] /= o;
            else for (i = 0; i < n; i++) stackData[i][j][1] = k;
          }
          for (j = 0; j < m; ++j) y0[j] = 0;
          return y0;
        };
...
var CryptoJS =
  ...
  (function (t, e) {
    var n = {},
      ...
      o = (i.WordArray = r.extend({
        ...
        concat: function (t) {
          ...
          if ((this.clamp(), i % 4))
            ...
            for (var o = 0; r > o; o += 4) e[(i + o) >>> 2] = n[o >>> 2];
      ...
      a = (s.Hex = {
        stringify: function (t) {
          for (var e = t.words, n = t.sigBytes, i = [], r = 0; n > r; r++) {
      ...
      d =
        ((s.Base64 = {
            ...
            for (var r = [], o = 0; n > o; o += 3)
              for (
                var s = (e[o >>> 2] >>> (24 - (o % 4) * 8)) & 255,
                  ...
                  p = (e[(o + 2) >>> 2] >>> (24 - ((o + 2) % 4) * 8)) & 255,
                  c = (s << 16) | (a << 8) | p,
                  d = 0;
                4 > d && n > o + 0.75 * d;
                d++
              )
                r.push(i.charAt((c >>> (6 * (3 - d))) & 63));
            var h = i.charAt(64);
          ...
          parse: function (t) {
            ...
            for (var s = [], a = 0, p = 0; e > p; p++)
              if (p % 4) {
                var c = n.indexOf(t.charAt(p - 1)) << ((p % 4) * 2),
                  d = n.indexOf(t.charAt(p)) >>> (6 - (p % 4) * 2);
                (s[a >>> 2] |= (c | d) << (24 - (a % 4) * 8)), a++;
              }
            return o.create(s, a);
          },
          _map: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
        }),
        (i.BufferedBlockAlgorithm = r.extend({
          reset: function () {
          ...
          _process: function (e) {
            var n = this._data,
              ...
              a = 4 * s,
              p = r / a;
            p = e ? t.ceil(p) : t.max((0 | p) - this._minBufferSize, 0);
            var c = p * s,
              d = t.min(4 * c, r);
            if (c) {
              for (var h = 0; c > h; h += s) this._doProcessBlock(i, h);
              var l = i.splice(0, c);
              n.sigBytes -= d;
            }
        ...
        _doProcessBlock: function (t, e) {
          for (
            ...
            if (16 > p) u[p] = 0 | t[e + p];
              ...
              var c = u[p - 3] ^ u[p - 8] ^ u[p - 14] ^ u[p - 16];
              u[p] = (c << 1) | (c >>> 31);
            }
            var d = ((i << 5) | (i >>> 27)) + a + u[p];
            (d +=
              20 > p
                ? ((r & o) | (~r & s)) + 1518500249
                : 40 > p
    ...
    return (
      (n.SHA1 = h._createHelper(f)), (n.HmacSHA1 = h._createHmacHelper(f)), n
    );
  })(Math);
!(function (t) {
  t.verbs = {
  ...
  (function (t) {
    ...
    function i(t, e) {
      for (var n in e) {
        (prop = e[n]), console.log(n + " : " + prop);
        try {
          e[n].constructor == Object
            ? (t[n] = i(t[n], e[n]))
            : (void 0 == t && (t = new Object()), (t[n] = e[n]));
        } catch (r) {
          void 0 == t && (t = new Object()), (t[n] = e[n]);
        }
      }
    ...
    function r(t) {
      ...
      if (((e = o()), void 0 !== e)) {
        for (var a = 0; a < r.length; a++)
          (n = r[a]), e[n] && ((s[n] = e[n]), delete e[n]);
        (s.extended = e), (s = i(t, s));
      } else s = t;
      return s;
    }
    function o() {
      var t, e, n, i, r, o;
      if (((t = window.location.href.split("?")), 2 === t.length))
        for (e = t[1], n = e.split("&"), o = {}, r = 0; r < n.length; r++)
          (i = n[r].split("=")),
            2 === i.length && i[0] && (o[i[0]] = decodeURIComponent(i[1]));
      return o;
    }
    function a() {
      var e = new XMLHttpRequest(),
        n = window.location + "?forcenocache=" + t.ruuid();
    ...
    function p(t, e, n, i) {
      var r = e,
        ...
        s = r.indexOf("?");
      if (
        (s > 0 && (o.push(r.substr(s + 1)), (r = r.substr(0, s))),
        (r = r + "?method=" + t),
        null !== n)
      )
        for (var a in n) o.push(a + "=" + encodeURIComponent(n[a]));
      return (
        null !== i && o.push("content=" + encodeURIComponent(i)),
    ...
    var c = (function () {
      var t = {};
      t.endpoint = "http://localhost:8000/xapi/";
      try {
        t.auth = "Basic " + toBase64("tom:1234");
      } catch (e) {
        n("Exception in Config trying to encode auth: " + e);
      }
      return t;
    })();
    (XAPIWrapper = function (n, o) {
      function s(e) {
        ...
        return (
          ...
          n.protocol && n.host
            ? n.protocol + "//" + n.host
            : void t.XAPIWrapper.log(
                "Couldn't create base url from endpoint: " + this.lrs.endpoint
              )
        );
      }
      function a(t, e, n) {
        t.auth = "Basic " + toBase64(e + ":" + n);
      }
      (this.lrs = r(n)),
        this.lrs.user &&
          this.lrs.password &&
          a(this.lrs, this.lrs.user, this.lrs.password),
              ...
              if (200 == e.status)
                try {
                  var n = JSON.parse(e.response),
                    i = !1;
                  for (var r in n.version)
                    if (n.version[r] == t.XAPIWrapper.xapiVersion) {
                      i = !0;
                      break;
                    }
                  i ||
                    t.XAPIWrapper.log(
                      "The lrs version [" +
                        ...
                        t.XAPIWrapper.xapiVersion +
                        "]"
                    );
                } catch (o) {
                  t.XAPIWrapper.log("The response was not an about object");
                }
              else
                t.XAPIWrapper.log(
                  "The request to get information about the LRS failed: " + e
                );
            }
          ),
        ...
        (this.hash = function (e) {
          ...
          try {
            ...
            return t.XAPIWrapper.log("Error trying to hash -- " + n), null;
          }
        }),
        (this.changeConfig = function (e) {
          try {
            t.XAPIWrapper.log("updating lrs object with new configuration"),
              (this.lrs = i(this.lrs, e)),
              e.user &&
                e.password &&
                this.updateAuth(this.lrs, e.user, e.password),
              (this.base = s(this.lrs.endpoint));
          } catch (n) {
            t.XAPIWrapper.log("error while changing configuration -- " + n);
          }
        }),
        (this.updateAuth = a);
    }),
      ...
      (XAPIWrapper.prototype.prepareStatement = function (t) {
        void 0 === t.actor
      ...
      (XAPIWrapper.prototype.testConfig = e),
      (XAPIWrapper.prototype.log = n),
      (XAPIWrapper.prototype.sendStatement = function (e, n) {
        if (this.testConfig()) {
          this.prepareStatement(e);
          var i;
          e.id ? (i = e.id) : ((i = t.ruuid()), (e.id = i));
          var r = t.XHR_request(
            this.lrs,
          ...
          if (!n) return { xhr: r, id: i };
        }
      }),
      (XAPIWrapper.prototype.sendStatements = function (e, n) {
        if (this.testConfig()) {
          for (var i in e) this.prepareStatement(e[i]);
          var r = t.XHR_request(
            this.lrs,
            this.lrs.endpoint + "statements",
            "POST",
      ...
      (XAPIWrapper.prototype.getStatements = function (e, n, i) {
        if (this.testConfig()) {
          var r = this.lrs.endpoint + "statements";
          if (n) r = this.base + n;
          else {
            var o = new Array();
            for (s in e) o.push(s + "=" + encodeURIComponent(e[s]));
            o.length > 0 && (r = r + "?" + o.join("&"));
          }
          var a = t.XHR_request(this.lrs, r, "GET", null, this.lrs.auth, i);
      ...
      (XAPIWrapper.prototype.getActivities = function (e, n) {
        if (this.testConfig()) {
          var i = this.lrs.endpoint + "activities?activityId=<activityid>";
          i = i.replace("<activityid>", encodeURIComponent(e));
          var r = t.XHR_request(
            this.lrs,
            i,
            "GET",
          ...
          if (void 0 === r || 404 == r.status) return null;
          try {
      ...
      (XAPIWrapper.prototype.sendState = function (e, i, r, o, s, a, p, c) {
        if (this.testConfig()) {
          var d =
            this.lrs.endpoint +
            "activities/state?activityId=<activity ID>&agent=<agent>&stateId=<stateid>";
          (d = d.replace("<activity ID>", encodeURIComponent(e))),
            (d = d.replace("<agent>", encodeURIComponent(JSON.stringify(i)))),
            (d = d.replace("<stateid>", encodeURIComponent(r))),
            o && (d += "&registration=" + encodeURIComponent(o));
          var h = null;
          a && p
            ? n("Can't have both If-Match and If-None-Match")
            : a
            ? (h = { "If-Match": '"' + a + '"' })
            : p && (h = { "If-None-Match": '"' + p + '"' });
          var l = "PUT";
          if (!s) return this.log("No activity state was included."), !1;
          s instanceof Array
            ? ((s = JSON.stringify(s)),
              (h = h || {}),
            ...
            t.XHR_request(this.lrs, d, l, s, this.lrs.auth, c, null, null, h);
        }
      }),
      (XAPIWrapper.prototype.getState = function (e, n, i, r, o, s) {
        if (this.testConfig()) {
          var a =
            this.lrs.endpoint +
            "activities/state?activityId=<activity ID>&agent=<agent>";
          (a = a.replace("<activity ID>", encodeURIComponent(e))),
            (a = a.replace("<agent>", encodeURIComponent(JSON.stringify(n)))),
            i && (a += "&stateId=" + encodeURIComponent(i)),
            r && (a += "&registration=" + encodeURIComponent(r)),
            o && (a += "&since=" + encodeURIComponent(o.toISOString()));
          var p = t.XHR_request(
            this.lrs,
            a,
            "GET",
      ...
      (XAPIWrapper.prototype.sendActivityProfile = function (e, i, r, o, s, a) {
        if (this.testConfig()) {
          var p =
            this.lrs.endpoint +
            "activities/profile?activityId=<activity ID>&profileId=<profileid>";
          (p = p.replace("<activity ID>", encodeURIComponent(e))),
            (p = p.replace("<profileid>", encodeURIComponent(i)));
          var c = null;
          o && s
            ? n("Can't have both If-Match and If-None-Match")
            : o
            ...
            : s && (c = { "If-None-Match": '"' + s + '"' });
          var d = "PUT";
          if (!r) return this.log("No activity profile was included."), !1;
          r instanceof Array
            ? ((r = JSON.stringify(r)),
              (c = c || {}),
            ...
            t.XHR_request(this.lrs, p, d, r, this.lrs.auth, a, null, !1, c);
        }
      }),
      (XAPIWrapper.prototype.getActivityProfile = function (e, n, i, r) {
        if (this.testConfig()) {
          var o =
            this.lrs.endpoint + "activities/profile?activityId=<activity ID>";
          (o = o.replace("<activity ID>", encodeURIComponent(e))),
            n && (o += "&profileId=" + encodeURIComponent(n)),
            i && (o += "&since=" + encodeURIComponent(i.toISOString()));
          var s = t.XHR_request(
            this.lrs,
            o,
            "GET",
          ...
          if (void 0 === s || 404 == s.status) return null;
          try {
            return JSON.parse(s.response);
          } catch (a) {
            return s.response;
          }
        }
      }),
      (XAPIWrapper.prototype.getAgents = function (e, n) {
        if (this.testConfig()) {
          var i = this.lrs.endpoint + "agents?agent=<agent>";
          i = i.replace("<agent>", encodeURIComponent(JSON.stringify(e)));
          var r = t.XHR_request(
            this.lrs,
            i,
            "GET",
      ...
      (XAPIWrapper.prototype.sendAgentProfile = function (e, i, r, o, s, a) {
        if (this.testConfig()) {
          var p =
            this.lrs.endpoint +
            "agents/profile?agent=<agent>&profileId=<profileid>";
          (p = p.replace("<agent>", encodeURIComponent(JSON.stringify(e)))),
            (p = p.replace("<profileid>", encodeURIComponent(i)));
          var c = null;
          o && s
            ? n("Can't have both If-Match and If-None-Match")
            ...
            : s && (c = { "If-None-Match": '"' + s + '"' });
          var d = "PUT";
          if (!r) return this.log("No agent profile was included."), !1;
          r instanceof Array
            ? ((r = JSON.stringify(r)),
              (c = c || {}),
              (c["Content-Type"] = "application/json"))
      ...
      (XAPIWrapper.prototype.getAgentProfile = function (e, n, i, r) {
        if (this.testConfig()) {
          var o = this.lrs.endpoint + "agents/profile?agent=<agent>";
          (o = o.replace("<agent>", encodeURIComponent(JSON.stringify(e)))),
            (o = o.replace("<profileid>", encodeURIComponent(n))),
            n && (o += "&profileId=" + encodeURIComponent(n)),
            i && (o += "&since=" + encodeURIComponent(i.toISOString()));
          var s = t.XHR_request(
            this.lrs,
      ...
      (t.dateFromISOString = function (t) {
        var e =
        ...
        n[3] && r.setMonth(n[3] - 1),
          ...
          n[14] &&
            ((i = 60 * Number(n[16]) + Number(n[17])),
            (i *= "-" == n[15] ? 1 : -1)),
          (i -= r.getTimezoneOffset()),
          (time = Number(r) + 60 * i * 1e3);
        var o = new Date();
        return o.setTime(Number(time)), o;
      }),
      (t.XHR_request = function (e, n, i, r, o, s, c, d, h) {
        "use strict";
        function l() {
          if (m) return v;
          m = !0;
          var t = d && 404 === u.status;
          if (
            !(void 0 === u.status || (u.status >= 200 && u.status < 400) || t)
          ) {
            try {
              alert(
        ...
        if (
          ...
          (w.Authorization = o),
          (w["X-Experience-API-Version"] = t.XAPIWrapper.xapiVersion),
          null !== h)
        )
          for (var A in h) w[A] = h[A];
        if (
          ((S =
            I.protocol.toLowerCase() !== b[1] ||
            I.hostname.toLowerCase() !== b[2]),
          S ||
            ((g = null === b[3] ? ("http" === b[1] ? "80" : "443") : b[3]),
            (S = g === I.port)),
          S && "undefined" != typeof XDomainRequest)
        )
          (x = !0),
            (f = p(i, n, w, r)),
            (u = new XDomainRequest()),
            u.open(f.method, f.url);
        else {
          (u = new XMLHttpRequest()), u.open(i, n, null != s);
          for (var A in w) u.setRequestHeader(A, w[A]);
        }
        if (
          ((u.onreadystatechange = function () {
            return 4 === u.readyState ? l() : void 0;
          }),
          (u.onload = l),
          (u.onerror = l),
          u.send(x ? f.data : r),
      ...
      (t.XAPIWrapper = new XAPIWrapper(c, !1));
  })((window.ADL = window.ADL || {})),
  (function (t) {
    function e(t, n) {
      var i = n.split("."),
      ...
      return (
        (n = i.slice(1).join(".")),
        t[r] ||
          (/\[\]$/.test(r) ? ((r = r.slice(0, -2)), (t[r] = [])) : (t[r] = {})),
        n ? e(t[r], n) : t[r]
      );
    }
    var n = function (e, n, c) {
      if (e && e.actor && e.verb && e.object) {
        var d = e;
        for (var h in d)
          "actor" != h && "verb" != h && "object" != h && (this[h] = d[h]);
        (e = d.actor), (n = d.verb), (c = d.object);
      }
      e
        ? e instanceof i
          ? (this.actor = e)
          : "Agent" !== e.objectType && e.objectType
          ? "Group" === e.objectType && (this.actor = new r(e))
          : (this.actor = new i(e))
        : (this.actor = null),
        (this.verb = n ? (n instanceof o ? n : new o(n)) : null),
        (this.object = c
          ? "Activity" !== c.objectType && c.objectType
            ? "Agent" === c.objectType
              ? c instanceof i
                ? c
                : new i(c)
              ...
              ? c instanceof r
                ? c
                : new r(c)
              : "StatementRef" === c.objectType
              ? c instanceof a
                ? c
                : new a(c)
              : "SubStatement" === c.objectType
              ? c instanceof p
                ? c
                : new p(c)
              : null
    ...
    (n.prototype.toString = function () {
      ...
      (n.prototype.generateRegistration = function () {
        e(this, "context").registration = t.ruuid();
      }),
      (n.prototype.addParentActivity = function (t) {
        e(this, "context.contextActivities.parent[]").push(new s(t));
      }),
      (n.prototype.addGroupingActivity = function (t) {
        e(this, "context.contextActivities.grouping[]").push(new s(t));
      }),
      (n.prototype.addOtherContextActivity = function (t) {
        e(this, "context.contextActivities.other[]").push(new s(t));
      });
    var i = function (t, e) {
      if (
    ...
    var r = function (t, e, n) {
      i.call(this, t, n), (this.member = e), (this.objectType = "Group");
    };
    r.prototype = new i();
    var o = function (t, e) {
      if (t && t.id) for (var n in t) this[n] = t[n];
      else
        (this.id = t),
          e &&
            (this.display =
              "string" == typeof e || e instanceof String ? { "en-US": e } : e);
    };
        ...
        (this.objectType = "Activity"),
          ...
          (e || n) &&
            ...
            "string" == typeof n || n instanceof String
              ? (this.definition.description = { "en-US": n })
              : n && (this.definition.description = n));
    };
    ...
    (p.prototype = new n()),
      (p.prototype.toString = function () {
        return '"' + p.prototype.prototype.toString.call(this) + '"';
      }),
      (n.Agent = i),
      (n.Group = r),
      (n.Verb = o),
...
(function (ADL) {
  ...
  XAPIDashboard.prototype.fetchAllStatements = function (query, wrapper, cb) {
    ...
    if (!wrapper || typeof wrapper === "function") {
      if (typeof wrapper === "function" && !cb) cb = wrapper;
  ...
  ADL.select = function (xpath) {
    var innerFn = function (opts, join) {
      if (!opts.groupBy) {
        console.error(
          "group has not been specified, aborting aggregation",
          opts
        );
        return;
      }
    ...
    var innerFn = function (opts, join) {
      ...
      if (join !== true) {
        var range = opts.range
          ? [opts.range.start, opts.range.end, opts.range.increment]
          : null;
        var rangeLabel;
        if (opts.rangeLabel === "start") rangeLabel = "groupStart";
        else if (opts.rangeLabel === "end") rangeLabel = "groupEnd";
        else rangeLabel = opts.rangeLabel || "group";

        return (opts.data = ret
          .groupBy(opts.groupBy, range)
          .count()
          .select(rangeLabel + " as in, count as out")
          .exec(opts.cb));
      } else {
  ...
  ADL.sum = function (xpath) {
    var innerFn = function (opts, join) {
      if (!opts.groupBy || !xpath) {
        console.error(
          "group or xpath has not been specified, aborting aggregation",
          opts
        );
        return;
      }
      ...
      if (join !== true) {
        ...
        return (opts.data = ret
          .groupBy(opts.groupBy, range)
          .sum(xpath)
          .select(rangeLabel + " as in, sum as out")
          .exec(opts.cb));
      } else {
    ...
    var innerFn = function (opts, join) {
      ...
      if (join !== true) {
        ...
        return (opts.data = ret
          .groupBy(opts.groupBy, range)
          .min(xpath)
          .select(rangeLabel + " as in, min as out")
          .exec(opts.cb));
      } else {
    ...
    var innerFn = function (opts, join) {
      ...
      if (join !== true) {
        ...
        return (opts.data = ret
          .groupBy(opts.groupBy, range)
          .max(xpath)
          .select(rangeLabel + " as in, max as out")
          .exec(opts.cb));
      } else {
    ...
    var innerFn = function (opts, join) {
      ...
      if (join !== true) {
        ...
        return (opts.data = ret
          .groupBy(opts.groupBy, range)
          .average(opts.xpath)
          .select(rangeLabel + " as in, average as out")
          .exec(opts.cb));
      } else {
  ...
  ADL.multiAggregate = function (xpath) {
    ...
    var innerFn = function (opts) {
      ...
      opts.data =
        opts.groupByLevel > 0
          ? opts.data.groupBy(opts.groupBy).groupBy(opts.innerGroupBy)
          : opts.data.groupBy(opts.groupBy);
      ...
      for (var i = 0; i < multi.length; i++) {
        ...
        if (multi[i]._inner) {
          ...
          console.error(
            "If an xpath is not provided to multiAggregate, then it must be provided to each aggregation function"
          );
        }
      }
            ...
            for (var i in firstElem[j]) {
              if (ignoreKeys.indexOf(i) < 0) {
                ...
                for (var z = 0; z < data.length; z++) {
                  if (data[z].data[j]) {
                    data[z].data[j][keyName] =
                      data[z].data[j][i] == undefined ? 0 : data[z].data[j][i];
                  } else {
          ...
          do {
            ...
            for (g = 0; g < aggArr.length; g++) {
              if (tempData[aggArr[g].key] != undefined) {
                aggArr[g].values.push({
                  in: data[i].group,
                  out: tempData[aggArr[g].key],
                  series: g
                });
              }
            }
      ...
      bars
        ...
        .on("mouseover", function (d, i) {
          ...
          dispatch.elementMouseover({
            ...
            pos: [
              x(getX(d, i)) +
                (x.rangeBand() * (stacked ? data.length / 2 : d.series + 0.5)) /
                  data.length,
              y(getY(d, i) + (stacked ? d.y0 : 0))
            ], // TODO: Figure out why the value appears to be shifted
            pointIndex: i,
...
(function (ADL) {
  ...
  Chart.prototype.draw = function (container) {
    ...
    if ((!opts.aggregate && !opts.process) || !opts.chartType || !container) {
      console.error(
        "Must specify aggregate function, chartType, and container before drawing chart",
        opts
      );
      return;
    }
    ...
    function cb(aggregateData) {
      if (opts.post) {
        ...
        var temp =
          opts.post.call(self, tempCollection, event) || tempCollection;

        //If temp is a collection, assign temp.contents. If not, then it's just an array.
        aggregateData =
          temp.contents && temp.contents.length >= 0 ? temp.contents : temp;
      }
  ...
  Chart.prototype.getSVGDataURI = function () {
    return (
      ...
      btoa("<svg>" + ADL.$(this.opts.container).innerHTML + "</svg>")
    );
  };
  ...
  function addChart(self, aggregateData) {
    ...
    if (
      self.opts.chartType != "multiBarChart" &&
      !(self.opts.chartType == "table" && self.isMulti)
    ) {
      opts.aggregateData = ADL.CollectionSync.prototype.toCSV.call({
        contents: aggregateData
      });
    } else {
    ...
    nv.addGraph(function () {
      ...
      if (opts.customize) opts.customize(chart, event);

      var next = self.child || self.parent;

      if (opts.click)
        chart[opts.eventChartType].dispatch.on("elementClick", opts.click);
        ...
        chart[opts.eventChartType].dispatch.on("elementClick", function (e) {
          ...
          if (next instanceof Array) {
            ...
            if (next != self.parent) next.event = e;
  ...
  function BarChart(opts) {
    ...
    this.opts.aggregate = this.opts.aggregate
      ? this.opts.aggregate
      : ADL.count();

    this.opts.nvd3Opts = this.opts.nvd3Opts
      ? this.opts.nvd3Opts
      : {
          x: function (d) {
            return d.in;
  ...
  PieChart.prototype.pipeData = function (obj, chart) {
    d3.select(this.opts.container).datum(obj).call(chart);
  };
  ...
  MultiBarChart.prototype.getCSVString = function () {
    ...
    var str = '"' + this.opts.groupBy + '",',
      arr = this.opts.aggregateData;
  ...
  function LinePlusBarChart(opts) {
    ...
    this.opts.nvd3Opts = this.opts.nvd3Opts
      ...
      : {
          ...
          y: function (d, i) {
            console.log(d.out ? d.out : 0);
            return d.out ? d.out : 0;
          },
          showXAxis: true,
          showYAxis: true,
          transitionDuration: 250,
  ...
  LinePlusBarChart.prototype.pipeData = function (obj, chart) {
    ...
    d3.select(this.opts.container).datum(newArr).call(chart);
  };
    ...
    opts.cb = function (aggregateData) {
      ...
      if (aggregateData[0] && aggregateData[0].values) {
        ...
        for (var i = -1; i < aggregateData[0].values.length; i++) {
          ...
          markup +=
            i >= 0
              ? "<tr><td>" + aggregateData[g].values[i].in + "</td>"
              : "<tr><th>" + opts.groupBy + "</th>";

          for (; g < aggregateData.length; g++) {
            if (i >= 0)
              markup += "<td>" + aggregateData[g].values[i].out + "</td>";
        ...
        self.isMulti = false;
        markup +=
          "<tr><th>" + opts.groupBy + "</th><th>" + opts.xpath + "</th></tr>";
